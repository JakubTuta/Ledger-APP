...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetFeatureFlags = channel.unary_unary(
                '/auth.AuthService/GetFeatureFlags',
                request_serializer=auth__pb2.GetFeatureFlagsRequest.SerializeToString,
                response_deserializer=auth__pb2.GetFeatureFlagsResponse.FromString,
                _registered_method=True)
        self.SetFeatureFlag = channel.unary_unary(
                '/auth.AuthService/SetFeatureFlag',
                request_serializer=auth__pb2.SetFeatureFlagRequest.SerializeToString,
                response_deserializer=auth__pb2.SetFeatureFlagResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetFeatureFlags': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.GetFeatureFlagsRequest.FromString,
                    response_serializer=auth__pb2.GetFeatureFlagsResponse.SerializeToString,
            ),
            'SetFeatureFlag': grpc.unary_unary_rpc_method_handler(
                    servicer.SetFeatureFlag,
                    request_deserializer=auth__pb2.SetFeatureFlagRequest.FromString,
                    response_serializer=auth__pb2.SetFeatureFlagResponse.SerializeToString,
            ),
...
class AuthService(object):
    ...
    def GetFeatureFlags(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/GetFeatureFlags',
            auth__pb2.GetFeatureFlagsRequest.SerializeToString,
            auth__pb2.GetFeatureFlagsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SetFeatureFlag(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/SetFeatureFlag',
            auth__pb2.SetFeatureFlagRequest.SerializeToString,
            auth__pb2.SetFeatureFlagResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
